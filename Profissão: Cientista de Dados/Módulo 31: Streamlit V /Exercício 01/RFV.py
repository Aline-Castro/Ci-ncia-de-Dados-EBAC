...
def main():
    ...
    <div style="text-align:center">
        <a href="https://github.com/Aline-Castro/Ciencia-de-Dados">
            <img src="https://raw.githubusercontent.com/rhatiro/Curso_EBAC-Profissao_Cientista_de_Dados/main/ebac-course-utils/media/logo/ebac_logo-data_science.png"  width=100%>
        </a>
    </div> 
